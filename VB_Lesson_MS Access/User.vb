Public Class User
    ...
    Public Sub Simpan()
        ...
        If (user_baru = True) Then
            strsql = "Insert into users(username,nama_lengkap,passwd) values ('" & _username & "','" & _nama_lengkap & "','" & _passwd & "')"
            info = "INSERT"
        Else
            strsql = "update users set username='" & _username & "', nama_lengkap='" & _nama_lengkap & "', passwd='" & _passwd & "' where username='" & _username & "'"
            info = "UPDATE"
        End If
